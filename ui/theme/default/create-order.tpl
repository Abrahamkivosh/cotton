...
<div class="row">
	...
	{/if}
	<div class="card-body">
                <form class="form-horizontal" method="post" role="form" action="{$_url}order/order-add-post" >            
				   ...
				   <div class="form-group">
								...
								<div class="col-md-6">
									<select id="plan" name="ginner_id" class="form-control" required>
										...
										{foreach $ginner as $cs}
											<option value="{$cs['id']}">{$cs['name']}-{$cs['phonenumber']}-{$cs['address']}</option>
										{/foreach}
									</select>
                    ...
                    <div class="form-group">
						...
						<div class="col-md-6">
							<input type="number" class="form-control"  name="qty" max="{$qty}" value="1" required>
						</div>
                    </div>
					 <div class="form-group">
						<label class="col-md-2 control-label">Price per qty</label>
						<div class="col-md-6">
							<input type="number" class="form-control" min="{$min}"  name="price" required>
						</div>
                    </div>
