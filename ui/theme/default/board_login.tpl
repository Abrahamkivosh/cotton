...
<div class="app-main__outer">
   ...
   <div class="main-card mb-2 card">
	<a class="btn btn-light btn-xl js-scroll-trigger" style="text-transform: none; color:white; background:green; padding: 12px ;width: 100%;  " href="{$_url}login/amcos">AMCOS Login</a>
	</div>
	</div>
    -->
	  <div class="col-md-2">
   ...
   <div class="main-card mb-2 card">
	...
	<!--<div class="col-md-2">
   <div class="main-card mb-2 card">
	<a class="btn btn-light btn-xl js-scroll-trigger" style="text-transform: none; color:dark; background:white; padding: 12px ;width: 100%;  " href="{$_url}admin">Super Admin</a>
	</div>
	</div>
	-->
	<div class="col-md-2">
	...
	<div class="panel-body">
						...
						<form  action="{$_url}admin/post-board" method="post">
