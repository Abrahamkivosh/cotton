   ...
   <center> <a href="{$_url}/main"><img src="{$_c['company_logo']}" width="40%;"></a></center>
                   ...
                   Enter the Phone Number You registered with<br><br>
                    <div style="font-size: 15px">
                       <form class="form-horizontal" action="{$_url}register/forgot-pin-post" method="post">
                       ...
                       <br>
                       <a class="btn btn-light btn-xl js-scroll-trigger" style="text-transform: none; color:white; background:green; padding: 12px ;width: auto;  " href="{$_url}login">Cancel </a>
                    </div>
                </div>
            </div>
        </div>
