...
<div class="row">
			...
			<div class="app-page-title">
				<div class="page-title-wrapper">
					<div class="page-title-heading">
						...
						</div>Bandwidth periodic Graph</div></div>
			</div>
	...
	{/if}
	<div class="card-body">
                <form class="form-horizontal" method="post" role="form" action="{$_url}noc/graph-view">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Kindly Customer</label>
										<div class="col-md-6">
											<select id="personSelect" class="form-control" id="stype" name="id">

                                                                                            {foreach $cust as $ds}
												
												<option value="{$ds['id']}">{$ds['username']}-{$ds['fullname']}</option>
