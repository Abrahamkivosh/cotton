        ...
        <div class="container my-auto">
            <div class="row">
                ...
                <div class="col-lg-5 mx-auto" >
                    ...
                    <h2>Verify its Your Phone number</h2>

                    <div style="font-size: 15px">
                        <table ><tr><td style="text-align: left"> Enter the code</td><td style="text-align: right; color: #ffc400"> <a style="color: deepskyblue" href="{$_url}register/resend/{$id}">resend code?</a></td></tr></table>

                        <form  class="form-horizontal" action="{$_url}register/confirm_number" method="post">
