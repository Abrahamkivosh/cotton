...
<div class="row">
	...
	{/if}
	<div class="card-body">
                <form class="form-horizontal" method="post" role="form" action="{$_url}subvillages/subvillage-edit-post" >
                   ...
                   <div class="form-group">
	                 ...
	                 <div class="form-group">
								...
								<div class="col-md-6">
									<select id="personSelect" name="village_id" class="form-control" required>
										...
										{if $d['village_id'] eq $cs['id']}
												<option value="{$cs['id']}" selected>{$cs['village_name']}</option>
								     	{else}
					...
					<div class="form-group">
						<div class="col-lg-offset-2 col-lg-10">
							...
							Or <a href="{$_url}subvillages/list">{$_L['Cancel']}</a>
						</div>
					</div>
                </form>
