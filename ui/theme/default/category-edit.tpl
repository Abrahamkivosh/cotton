...
<div class="row">
	...
	{/if}
	<div class="card-body">
                <form class="form-horizontal" method="post" role="form" action="{$_url}category/category-edit-post" >
				<input type="hidden" name="id" value="{$d['id']}">				
					...
					<div class="form-group">
						<div class="col-lg-offset-2 col-lg-10">
							...
							Or <a href="{$_url}category/list">{$_L['Cancel']}</a>
						</div>
					</div>
                </form>
