			...
			<div class="page page-auth">
				...
				{/if}
					<div class="form-container">
						...
						<br>
						<a class="btn btn-light btn-xl js-scroll-trigger" style="text-transform: none; color:white; background:orange; padding: 12px ;width: 33%;  " href="{$_url}admin">Agent Log in</a>
