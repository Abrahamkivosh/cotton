...
<div class="row">
	...
	{/if}
	<div class="card-body">
                <form class="form-horizontal" method="post" role="form" action="{$_url}input/inputs-edit-post" >
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">
						...
						<div class="col-md-6">
							<input type="number" class="form-control"   name="rate_per_acre"  value="{$d['rate_per_acre']}" required>
						</div>
                    </div>
