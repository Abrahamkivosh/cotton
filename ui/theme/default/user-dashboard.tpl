							...
							<div class="panel-body" style="height:296px;max-height:296px;overflow:scroll;">
								<p>{$_L['Welcome_Text_User']}</p>
									<ul>
										...
										<li> <a href="{$_url}voucher/activation">Payment Activation</a></li>
										<li> <a href="{$_url}voucher/list-activated">List Activated Payment</a></li>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="panel panel-primary panel-hovered panel-stacked mb30">
								<div class="panel-heading">Activate Payment</div>
									{if isset($notify)}
	{$notify}
	{/if}
	<div class="panel-body">
									<form class="form-horizontal" method="post" role="form" action="{$_url}voucher/activation-post" >
										<div class="form-group">
											<label class="col-md-4 control-label">MPESA CODE PAYMENT</label>
											<div class="col-md-6">
												<input type="text" class="form-control" id="code" name="code" placeholder="ZXCFRHDDED4">
											</div>
										</div>
