...
<div class="row">
	...
	{/if}
	<div class="card-body">
                <form class="form-horizontal" method="post" role="form" action="{$_url}reports/logs-after">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select id="personSelect" class="form-control" id="stype" name="stype">
									...
									<div class="form-group">
										<div class="col-sm-offset-3 col-sm-9">
											<button type="submit" id="submit" class="btn btn-primary">Logs Report</button>
										</div>
									</div>
								</form>
								</div>
