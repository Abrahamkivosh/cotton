			...
			<nav class="site-nav clearfix" role="navigation">
				...
				<ul class="list-unstyled clearfix nav-list mb15">
					...
					<li {if $_system_menu eq 'voucher'}class="open"{/if}>
						...
						<ul class="inner-drop list-unstyled">
							<li {if $_system_menu eq 'voucher'}class="active"{/if}><a href="{$_url}voucher/activation">Payment Activation</a></li>
							<li {if $_system_menu eq 'voucher'}class="active"{/if}><a href="{$_url}voucher/list-activated">List Payment</a></li>
						</ul>
					</li>
