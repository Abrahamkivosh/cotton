<?php /* Smarty version Smarty-3.1.13, created on 2022-05-14 07:06:23
         compiled from "ui/theme/default/forgotpin.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1822681149627f2abf2c91b4-04624838%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '302e1c1cd6cea3897adf366fbc5dd3c97bb68a9b' => 
    array (
      0 => 'ui/theme/default/forgotpin.tpl',
      1 => 1651116210,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1822681149627f2abf2c91b4-04624838',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627f2abf330b93_99272877',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627f2abf330b93_99272877')) {function content_627f2abf330b93_99272877($_smarty_tpl) {?>
<!DOCTYPE html>
<html lang="en">
...
register/forgot-pin-post" method="post">
                           <input type="number" max="251999999999" min="100000000" name="phone" class="form-control" style="height: 33px; width: 100%;" value="251" />
                           <br>
                           <br>
                           <input type="submit" class="btn btn-primary btn-xl js-scroll-trigger" style="background: purple; padding: 8px ; color: white; width: auto; " value="Submit">
                       </form>
                       <br>
                       <a class="btn btn-light btn-xl js-scroll-trigger" style="text-transform: none; color:white; background:green; padding: 12px ;width: auto;  " href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
login">Cancel </a>
                    </div>
                </div>
            </div>
